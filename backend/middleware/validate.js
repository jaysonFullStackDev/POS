...
const createProductRules = [
  ...
  body('recipe.*.ingredient_id').optional().isUUID().withMessage('Invalid ingredient ID in recipe'),
...
const processSaleRules = [
  ...
  body('payment_method').isIn(['cash', 'card', 'ewallet']).withMessage('Invalid payment method'),
...
const createIngredientRules = [
  ...
  body('supplier_id').optional({ nullable: true }).isUUID().withMessage('Invalid supplier ID'),
  handleErrors,
];

const stockMovementRules = [
  body('ingredient_id').isUUID().withMessage('Invalid ingredient ID'),
